...
type Props = { chapter: Chapter, unitIdx: number, chapterIdx: number}

export default function VideoSummary({ chapter, unitIdx, chapterIdx}: Props) {
  return <div className="flex flex-col gap-3 w-[70%]">
        <div className="flex flex-col gap-2">
           ...
           <p className="text-secondary-foreground/80 text-base font-semibold">{chapter.summary}</p>
        </div>
  </div>
}